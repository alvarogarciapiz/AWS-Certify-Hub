...
import downloadFile from "../assets/AWS-Certified-DevOps-Engineer-Professional.pdf";
...
function DevOpsEngineer() {
  ...
  const questionOptions = [10, 20, 30, 40, 50, 'All'];

  const handleStartExam = () => {
    localStorage.setItem("examQuestionCountPDOE", selectedQuestions);
    navigate("/exampdoe");
    setShowModal(false);
  };
        ...
        <Grid container spacing={5}>
          <Grid item xs={12} sm={6} md={4}>
            ...
            >
              ...
              <h2 className="cardsubtitle">DevOps Engineer</h2>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <div className="roundcard">
              <Link to="/examerrorspdoe" className="links">
                <img
                  className="roundimage"
                  src="/PDOE_errors.webp"
                  alt="DevOps errors"
                />
          ...
          <Grid item xs={12} sm={6} md={4}>
            <div className="roundcard">
              <a href={downloadFile} download className="links">
                <img
                  className="roundimage"
                  src="/PDOE_simulator.webp"
                  alt="DevOps simulator"
                />
